...
/**
 * Created by sakthivel on 19/12/2016.
 */

public class Signup extends AppCompatActivity {
    private EditText inputMail, inputPassword;
    private Button btnSignIn, btnSignUp, btnResetPwd;
...
//                auth.createUserWithEmailAndPassword("test","test").;
                //create user
                        ...
                        .addOnCompleteListener(Signup.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(Signup.this, Chats.class));
                                    finish();
                                }
                            }
                        });
